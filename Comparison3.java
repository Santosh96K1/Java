public class Comparison3 {
    ...
    int int_a = 30;
    double double_a = 70.5;
    char char_a = 'C';
    boolean boolean_a = false;
    String string_a = "java";
    float float_a = 55.5f;
    long long_a= 500L;
    short short_a = 25;
    byte byte_a = 5;
        ...
        System.out.println("intValue == 50: " + (int_a == 50));
        System.out.println("doubleValue == 60.5: " + (double_a == 60.5));
        System.out.println("charValue == 'E': " + (char_a == 'E'));
        System.out.println("booleanValue == true: " + (boolean_a == true));
        System.out.println("stringValue.equals " +string_a=="Computer");
        System.out.println("floatValue == 55.5f: " + (float_a == 5.5f));
        System.out.println("longValue == 500L: " + (long_a == 100L));
        System.out.println("shortValue == 25: " + (short_a == 5));
        System.out.println("byteValue == 5: " + (byte_a == 25));
    }
